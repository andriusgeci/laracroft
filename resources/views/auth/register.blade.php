                    ...
                    <form action="{{ route('register') }}" method="POST">
                        ...
                        <div class="form-group my-1">
                            ...
                            <input type="email" name="email" class="form-control @error('email') is-invalid
                                   @enderror" value="{{ old('email') }}" placeholder="Email Address" required>
                            @error('email')
                        ...
                        <div class="row">
                            ...
                            <div class="div col md-6 my-1">
                                <a href="{{ route('login') }}" class="btn btn-dark float-end">Got to login</a>
                            </div>
                        </div>
                    </form>
                </div>
